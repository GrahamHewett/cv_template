...
export default function() {
	return (
		...
		<ul className="list-unstyled contact-list">
		  ...
		  <li className="phone">
			<a href="tel:07710568338"><i className="fas fa-phone"></i>07710 568338</a>
		  </li>
		  <li className="linkedin">
			<i className="fab fa-linkedin-in"></i>
			<a href="https://www.linkedin.com/in/graham-hewett-88a88390/" target="_blank" rel="noopener noreferrer">
